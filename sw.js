const CACHE_NAME = 'love-app-v21-closed-window';
const ASSETS_TO_CACHE = ['./index.html', './realtime.js?v=4', './together.js?v=2', './manifest.json', './styles_cleaned.css', './styles_elegant.css?v=7', './together.css?v=9', './app_refresh.css?v=4', './icono-app.png', './perfil_yo.jpg', './princesa2.jpg'];
