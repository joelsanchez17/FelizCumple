const CACHE_NAME = 'love-app-v28-restore-tab';
const ASSETS_TO_CACHE = ['./index.html', './realtime.js?v=5', './together.js?v=9', './manifest.json', './styles_cleaned.css', './styles_elegant.css?v=7', './together.css?v=15', './app_refresh.css?v=4', './icono-app.png', './perfil_yo.jpg', './princesa2.jpg'];
