const CACHE_NAME = 'love-app-v40-house-pupito';
const ASSETS_TO_CACHE = ['./index.html', './realtime.js?v=6', './together.js?v=18', './manifest.json', './styles_cleaned.css', './styles_elegant.css?v=9', './together.css?v=24', './app_refresh.css?v=5', './icono-app.png', './perfil_yo.jpg', './princesa2.jpg'];
