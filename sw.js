const CACHE_NAME = 'love-app-v51-tail-offer-copy';
const ASSETS_TO_CACHE = ['./index.html', './realtime.js?v=6', './together.js?v=25', './manifest.json', './styles_cleaned.css', './styles_elegant.css?v=9', './together.css?v=34', './app_refresh.css?v=5', './icono-app.png', './perfil_yo.jpg', './princesa2.jpg', './besos.jpg', './assets/plants/bedroom-calathea-states.webp', './assets/plants/bathroom-orchid-states.webp', './assets/plants/kitchen-cactus-states.webp'];
